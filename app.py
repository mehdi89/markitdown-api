...
from converters.pdf_converter import convert_pdf_to_markdown
from converters.docx_converter import convert_docx_to_markdown
...
ALLOWED_EXTENSIONS = {'html', 'htm', 'pdf', 'docx', 'doc', 'txt', 'md', 'markdown'}
